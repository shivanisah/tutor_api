# Generated by Django 4.2 on 2023-06-22 03:31
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('Tutor', '0024_alter_enrollmentform_confirmeddate'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='Tutor.user')),
            ],
        ),
    ]
